...
//        this.rect = new Rectangle(dx1, dy1, dx2 - dx1, dy2 - dy1);
        ...
        rect[0] = new Rectangle(dx1, dy1+10, 10, (int) Point2D.distance(dx1, dy1+10, dx1, dy2-10));//izquierda 
        rect[1] = new Rectangle(dx2 -10, dy1+10, 10,(int) Point2D.distance(dx1, dy1+10, dx1, dy2-10) );//derecha
